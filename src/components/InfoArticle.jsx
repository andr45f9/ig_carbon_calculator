...
function InfoArticle() {
  return (
    <div className="InfoContainer">
      <article>
        <img src="./img/info_cloud1.webp" alt="A gradient cloud illustration" />
      ...
      <article>
        <img src="./img/info_cloud2.webp" alt="A gradient cloud illustration" />
      ...
      <article>
        <img src="./img/info_cloud3.webp" alt="A gradient cloud illustration" />
